...
export const LoginForm = () => {
  ...
  return (
    ...
    <form className="h-96 flex flex-col justify-between w-full max-w-[568px]"
      ...
      {loading ? <Loading />
        : <>
          ...
          <div className="flex gap-4 justify-around lg:justify-start">
            <button className="flex bg-black text-white items-center w-fit px-4 py-3 hover:opacity-50 text-small-price tracking-[0.2rem] border-2 border-solid border-black"
            type="submit"
            >ACCESS
            </button>

            <Link href={"/register"}>
              <button className="flex bg-white text-black items-center w-fit px-4 py-3 hover:bg-grey text-small-price tracking-[0.2rem] border-2 border-solid border-black"
              type="button"
              >REGISTER
              </button>
            </Link>
